// ABIs from verified Ronin Explorer sources. See research/DISCOVERY.md.
  ...
  },
  {
    ...
    "inputs": [
      ...
      },
      {
        ...
        "indexed": false,
        "internalType": "struct ILaunchpadStructs.CustomizedConfig",
...
export const nftAbi = [
  ...
  {
    "inputs": [],
    "name": "YAKKAMON_MARKETPLACE_ROLE",
    "outputs": [
      {
        "internalType": "bytes32",
        "name": "",
  ...
  },
  {
    "inputs": [
      {
        "internalType": "uint256",
        "name": "newLaunchpadStartId",
        "type": "uint256"
      }
    ],
    "name": "setLaunchpadStartId",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },
